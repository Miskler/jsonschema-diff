...
class PathUtils:
    ...
    def format_path(path: List[str]) -> str:
        ...
        Completely skips 'properties' keywords and determines schema
        ...
        while i < len(path):
            ...
            if segment == "properties":
                ...
                # Replace "items" with "[0]" only if there are more path
                # components after it that are not schema parameters
                # (i.e., field names)
                ...
                for j in range(i + 1, len(path)):
                    ...
                    if next_segment == "properties":
                        ...
                        # This could be a field name if we're not inside
                        # a schema context. We need to check the context
                        # more carefully
                        continue
    ...
    def parse_path(path_str: str) -> List[str]:
        ...
        Args:
            path_str: Formatted path string like '["field1"].type'
                     or '["field1"][0].format'
